...
\end{description}
The final result of what the rig looks like when put together correctly can be found in Fig~\ref{fig:RigDesign} and what the user sees can be found in Fig~\ref{fig:3Pview}.
...
\begin{figure}
   ...
   \caption{An approximate\footnote{The top and bottom of the image is cut of due to camera being able to capture non-wide screen video. During the experiment the user was able to see approximately 30 centimeters behind his/hers feet.} view of what the participant saw during the experiments.} \label{fig:3Pview}
\end{figure}
