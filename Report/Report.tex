...
\begin{figure}
   ...
   \caption{Less is better} \label{fig:Task1GraphP}
\end{figure}

\begin{figure}
   \centering
   \includegraphics[width=\textwidth]{ExternalMaterial/Task1GraphD}
   \caption{Less is better} \label{fig:Task1GraphD}
\end{figure}
...
\begin{figure}
   ...
   \caption{Less is better} \label{fig:Task2GraphP}
\end{figure}

\begin{figure}
   \centering
   \includegraphics[width=\textwidth]{ExternalMaterial/Task2GraphD}
   \caption{Less is better} \label{fig:Task2GraphD}
\end{figure}
...
\begin{figure}
   ...
   \caption{Less is better} \label{fig:Task3GraphP}
\end{figure}

\begin{figure}
   \centering
   \includegraphics[width=\textwidth]{ExternalMaterial/Task3GraphD}
   \caption{Less is better} \label{fig:Task3GraphD}
\end{figure}
