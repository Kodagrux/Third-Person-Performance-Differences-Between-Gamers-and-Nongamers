...
\begin{itemize}
	\item Gamers slightly better when wearing goggles, worse when not wearing goggles. No significant results unfortunately. See~\ref{tab:Task1GraphP}
...
\end{tabular}
\caption{Average performance (tries required, where less is better) for the two groups for task 1.}
\end{table}
...
\section{Appendix}
All the files for this report, along with all the 3D-design-files can be found and downloaded on the GitHub-page\footnote{More info can be found at https://github.com/Kodagrux/Third-Person-Performance-Differences-Between-Gamers-and-Nongamers} for this project.
