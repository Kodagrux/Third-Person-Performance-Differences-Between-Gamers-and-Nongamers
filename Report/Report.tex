...
After each test subject finishes his/hers precipitation in the experiment they are prompted to fill in a form regarding the experience and their prior experience with video games. Each test subject also fills in details about name, age and sex so the test data can be paired up with the survey. The details where later removed in the results in order to protect the test subjects anonymity.
