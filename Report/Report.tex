...
\begin{description}
   \item[Accuracy Test] The test subject rolls a ball and hits a target in order for it to successfully complete the task. Number of tries required will be noted.
   ...
   \item[Movement Test] The test subject walks forward facing, in their normal walking speed, thorough a preplanned course on flat ground marked with cones as precise as possible. This test measures the participants movement skills and is uses the time required 
\end{description}
