...
Experiments measuring navigation and movement performance~\cite{ruddle2013learning}, similar to our experiments, have also been conducted. These were performed in virtual reality (VR) using a wide range of interfaces (joystick-only, to linear and omni-directional treadmills, and actual walking) to control their navigation in the VR world. Further studies suggest that walking interfaces are to be preferred when navigating three-dimensional virtual environments~\cite{ruddle2009benefits}.
